		...
		if ${Time.Timestamp} > ${This.NextPulse.Timestamp}
		{
			...
			else
			{
	    		...
	    		This.NextPulse:Update
               		...
               		if ${SystemSafe}
                	{
				;UI:UpdateConsole["Alarm?: ${NotSafe}"]
				;echo Alarm?: ${NotSafe}
			...
			{
				NotSafe:Set[TRUE]
				;echo We need be carefull and keep align to POS: ${NotSafe}
				UI:UpdateConsole["We need be carefull and keep align to POS: ${NotSafe}"]
